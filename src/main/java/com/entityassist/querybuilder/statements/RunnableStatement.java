...
abstract class RunnableStatement
{
	...
	protected RunnableStatement(RootEntity obj)
	{
		this.obj = obj;
	}
	 ...
	 *
	 * @param updateFields Returns a map of field to update with the values
	 * @return A map of SingularAttribute and its object type
	 */
	@SuppressWarnings("WeakerAccess")
	@NotNull
	public Map<Field, Object> getUpdateFieldMap(RootEntity<?, ?, ?> updateFields)
	{
